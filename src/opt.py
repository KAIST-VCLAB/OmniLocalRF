...
def config_parser(cmd=None):
    ...
    parser.add_argument(
        "--datadir", type=str, default="./data/omnilocalrf/real/yongsil", help="input data directory"
    )
    parser.add_argument(
    ...
    ## training options    
    parser.add_argument("--bidirectional_optimization", type=int, default=1)
    # learning rate
    ...
    parser.add_argument("--lr_dyn", type=float, default=1e-3, help="Neural feature grid of dynamic fields learning rate")
    parser.add_argument("--lr_dyn_mlp", type=float, default=1e-3, help="MLP of dynamic fields learning rate")
    ...
    parser.add_argument("--loss_beta_dist", type=float, default=1e-5)
    parser.add_argument("--loss_dyn_weight", type=float, default=1e-2)
    parser.add_argument("--loss_dyn_binary", type=float, default=1e-1)
    ...
    parser.add_argument("--TV_dyn", type=float, default=1e-2, help="loss weight")#0.01
    ...
    parser.add_argument("--fin_alpha_block", type=int, default=0, help="If > 1, alpha of the last sample along a ray will be 1")

    parser.add_argument("--dyn_block_iter", type=int, default=2000)
    ...
    parser.add_argument("--fov", type=float, default=360, help="horizontal FoV in degree")
